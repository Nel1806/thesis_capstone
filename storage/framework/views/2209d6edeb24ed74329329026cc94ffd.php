...
<head>
    ...
    <title><?php echo e($title ?? 'Teacher Audit System'); ?></title>
    <style>
        :root {
            --blue: #1f5fbd;
            --blue-dark: #16499a;
    ...
    <div class="shell">
        <aside class="sidebar">
            ...
            <nav class="nav">
                ...
                <a class="<?php echo e(request()->routeIs('schools') ? 'active' : ''); ?>" href="<?php echo e(route('schools')); ?>">School Audit</a>
                <a class="<?php echo e(request()->routeIs('parameters') ? 'active' : ''); ?>" href="<?php echo e(route('parameters')); ?>">Parameters</a>
...
<?php /**PATH C:\eicee desktop\thesis 2.0\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>