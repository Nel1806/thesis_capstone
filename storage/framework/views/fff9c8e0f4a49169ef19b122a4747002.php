...
<body>
    <main class="login">
        ...
        <section class="panel">
            <form class="form" method="POST" action="<?php echo e(route('login.store')); ?>">
                <?php echo csrf_field(); ?>
                <h3>Sign In</h3>
                ...
                <div class="field">
                    ...
                    <input id="email" name="email" type="email" value="<?php echo e(old('email', 'admin@deped.gov.ph')); ?>" placeholder="name@deped.gov.ph" required autofocus>
                </div>
...
<?php /**PATH C:\eicee desktop\thesis 2.0\resources\views/auth/login.blade.php ENDPATH**/ ?>